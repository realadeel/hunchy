= Hunchy: Ruby library for the Hunch APIs
...
Hunch was released publicly on June 15, 2009. According to the developer site:
"Portions of the API are available currently, and the full API will be accessible after Hunch's full public launch."

Hunchy will be updated as more of the Hunch API becomes available. The library is also planned to be released as a gem soon. 
